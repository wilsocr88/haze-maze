...
public class Maze {
	...
	private static int		gridDimensionX;
	private static int		gridDimensionY;
	private static char[][]	grid;
	private Cell[][]		cells;
	private Random			random		= new Random();
	char					backChar	= '0', wallChar = '1', cellChar = '0', pathChar = '0', endChar = '5';
	int						wallCounter	= 0;
	...
	public void updateGrid() {
		...
		grid[gridDimensionX - 2][gridDimensionY - 2] = endChar;
